          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="page-header2">
                <h1 class="animated lightSpeedIn">Áreas de VECO</h1>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-sm-10"><br>
              <p class="lead text-info">Bienvenido <strong><?php echo $_SESSION['nombre_completo'];?></strong>, en esta página se muestran todas las áreas registradas en el sistema.</p>
            </div>
            <div clas="pull-left">
                            ...
                            if ($buscar_areas -> rowCount() > 0) { ?>
                                <div class="table-responsive">
                                    <table class="table table-hover table-striped table-bordered">
                                        ...
                                        ?>
                                                <td class="text-center"><?php echo $areas->id_area; ?></td>
