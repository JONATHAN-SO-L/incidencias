        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-sm-10"><br>
              <p class="lead text-info">Bienvenido(a) <strong><?php echo $_SESSION['nombre_completo'];?></strong>, en esta página se muestran <strong>todos los empleados de Morelos</strong>.</p>
            </div>
        ...
        if (isset($_POST['buscar_employee'])) {
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <a href="empleados_morelos.php" class="btn-sm btn btn-danger pull-right"><i class="fa fa-arrow-circle-left"></i> Regresar al inicio</a><br>
                            <?php
                            $buscar_empleados = $con->prepare("SELECT * FROM empleados WHERE nombre_colaborador LIKE '%$palabra_clave%' AND sede = 'Morelos' OR no_empleado LIKE '%$palabra_clave%' AND sede = 'Morelos' OR area LIKE '%$palabra_clave%' AND sede = 'Morelos' ORDER BY id_empleado ASC");
                            ...
                            // Contador de totales
                            $total_empleados = $con->prepare("SELECT COUNT(*) FROM empleados WHERE nombre_colaborador LIKE '%$palabra_clave%' AND sede = 'Morelos' OR no_empleado LIKE '%$palabra_clave%' AND sede = 'Morelos' OR area LIKE '%$palabra_clave%' AND sede = 'Morelos'");
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12">
                            ...
                            $buscar_empleados = $con->prepare("SELECT * FROM empleados WHERE sede = 'Morelos' ORDER BY area ASC");
                            $buscar_empleados->setFetchMode(PDO::FETCH_OBJ);
                            $buscar_empleados->execute();
                            ...
                            // Contador de totales
                            $total_empleados = $con->prepare("SELECT COUNT(*) FROM empleados WHERE sede = 'Morelos'");
                            $total_empleados->execute();
                            $num_total_empleados = $total_empleados->fetchColumn();
