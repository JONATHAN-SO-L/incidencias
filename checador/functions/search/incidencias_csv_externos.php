...
$filename = "Permisos_Ausentismo_".date('Y-m-d')."_Externos.csv";
...
$value="SELECT * FROM permisos WHERE fecha_ausencia BETWEEN '$fecha_inicio' AND '$fecha_fin' AND sede = 'Externo'"; 
