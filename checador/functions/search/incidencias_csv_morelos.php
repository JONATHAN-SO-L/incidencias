...
$filename = "Permisos_Ausentismo_".date('Y-m-d')."_Morelos.csv";
...
$value="SELECT * FROM permisos WHERE fecha_ausencia BETWEEN '$fecha_inicio' AND '$fecha_fin' AND sede = 'Morelos'"; 
