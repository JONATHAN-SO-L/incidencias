...
<div class="container"><br><br><br>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-sm-10">
              <p class="lead text-info">Bienvenido <strong><?php echo $_SESSION['nombre_completo'];?></strong>, en esta página se muestran todos los permisos registrados en el Sistema <strong>solo de MORELOS</strong>.</p>
            </div>
          
            <div class="col-sm-9">
            <form action="../checador/functions/search/incidencias_csv_morelos.php" method="POST">
    ...
    <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12">
                            ...
                            <a href="permisos_lista_morelos.php" class="btn-sm btn btn-danger pull-right"><i class="fa fa-arrow-circle-left"></i> Regresar al inicio</a><br><br>
                            <?php
                            /*********************
                            Resultados de busqueda
                            *********************/
                            $buscar_permisos = $con->prepare("SELECT * FROM permisos WHERE id_permiso LIKE '%$palabra_clave%' AND sede = 'Morelos' OR no_empleado LIKE '%$palabra_clave%' AND sede = 'Morelos' OR nombre_colaborador LIKE '%$palabra_clave%' AND sede = 'Morelos' ORDER BY id_permiso DESC");
...
<?php } else {
    ...
    $buscar_permisos = $con->prepare("SELECT * FROM permisos WHERE sede = 'Morelos' ORDER BY id_permiso DESC");
    $buscar_permisos->setFetchMode(PDO::FETCH_OBJ);
    $buscar_permisos->execute();
